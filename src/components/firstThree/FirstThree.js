    ...
    return (
			<section className={this.props.myClassName}>
				<div className="container">
					...
					{this.props.description&&<div className={`description-wrapper ${this.props.black}`}>
						{this.props.description}
					</div>}

                {this.props.price&&<div className={`price-wrapper ${this.props.grey}`}>
						{this.props.price}
					</div>}
					...
					{this.props.ipodPrice&&<div className="ipod-caption row">
